...
export const PRECOMPILE_INFO = {
  ...
  contractDeployerAllowList: {
    ...
    description:
      'Controls who can deploy smart contracts on your blockchain. Restricts contract deployment to authorized addresses only.',
  },
  nativeMinter: {
    address: '0x0200000000000000000000000000000000000001',
    name: 'Native Minter',
    description:
      'Allows authorized addresses to mint new native tokens, increasing the total supply on your blockchain.',
  },
  txAllowList: {
...
export const PREDEPLOY_INFO = {
  proxy: {
    ...
    description:
      'Enables upgradeability for smart contracts. Delegates calls to implementation contracts while preserving storage.',
    githubUrl:
      'https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.0/contracts/proxy/transparent/TransparentUpgradeableProxy.sol',
  },
  proxyAdmin: {
    address: '0xdad0000000000000000000000000000000000000',
    name: 'Proxy Admin Contract',
    description:
      'Manages upgrades for transparent proxies. Controls which addresses can upgrade proxy implementations.',
    githubUrl:
      'https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.0/contracts/proxy/transparent/ProxyAdmin.sol',
  },
  icmMessenger: {
    ...
    githubUrl:
      'https://github.com/ava-labs/icm-services/blob/main/icm-contracts/avalanche/teleporter/TeleporterMessenger.sol',
  },
  wrappedNativeToken: {
    ...
    githubUrl: 'https://github.com/ava-labs/icm-services/blob/main/icm-contracts/avalanche/ictt/WrappedNativeToken.sol',
  },
  ...
  multicall3: {
    ...
    name: 'Multicall3',
    description:
      'Batches multiple contract calls into a single transaction, reducing gas costs and improving efficiency.',
