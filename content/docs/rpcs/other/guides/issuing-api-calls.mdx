...
Primary Network and Avalanche L1 RPC calls
-------------------------------------------------------------------------------------------------------
...
Or for the Echo Avalanche L1 on the Fuji testnet:

```
http://127.0.0.1/ext/bc/98qnjenm7MBd8G2cPZoRvZrgJC33JGSAAKghsQ6eojbLCeRNp/rpc
```
