...
Here are a few examples on how a genesis file is used: [scripts/run.sh](https://github.com/ava-labs/avalanchego/blob/master/graft/subnet-evm/scripts/run.sh#L99)
