...
### EVM Avalanche L1 Settings

See the [EVM Core tutorial](/docs/tooling/avalanche-cli/create-deploy-avalanche-l1s/deploy-on-fuji-testnet#connect-with-core) for the walkthrough.
