...
| `autoRenewedValidatorOwners` | `PChainOwner`                 | No       | Auto-renewed validator owners to use for the transaction |
| `autoRenewedValidatorAuth`   | `number[]`                    | No       | Auto-renewed validator auth to use for the transaction   |
...
| `autoRenewedValidatorOwners` | `PChainOwner?`      | Auto-renewed validator owners used for the transaction |
| `autoRenewedValidatorAuth`   | `number[]?`         | Auto-renewed validator auth used for the transaction  |
