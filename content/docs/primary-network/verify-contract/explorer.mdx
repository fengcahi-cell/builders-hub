...
1. Navigate to the official [Avalanche Explorer](https://explorer.avax.network/) and click on **Tools** dropdown menu to select **Smart Contract Verification** interface. You may need to open the [Testnet Explorer](https://explorer-test.avax.network/) in case the contract is deployed on Fuji Testnet.
