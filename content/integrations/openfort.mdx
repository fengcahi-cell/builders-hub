...
description: "Create secure embedded wallets with easy authentication flows and gas sponsorship capabilities."
...
[Openfort Kit documentation →](https://www.openfort.io/docs/products/kit/react/quickstart)
...
[Invisible Wallet documentation →](https://www.openfort.io/docs/products/embedded-wallet/javascript)
...
[Cross-app Wallet documentation →](https://www.openfort.io/docs/products/cross-app-wallet/setup)
...
## Documentation
For more details, visit [Openfort Documentation](https://www.openfort.io/docs)
